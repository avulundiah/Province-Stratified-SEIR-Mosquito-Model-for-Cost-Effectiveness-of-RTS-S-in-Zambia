function validate_model_nls()
clc; close all;
    % MALARIA_MODEL_VALIDATION_WITH_CI
    % AVULUNDIAH PHIRI| 13 JUNE 2025
    ...
    % Plot median curves
    plot(years, IA_median, ':', 'Color', 'k', 'LineWidth', 2.5);
    ...
    legend('Model prediction with vaccine', 'Model prediction without vaccine', ...
                      'Emperical data');
